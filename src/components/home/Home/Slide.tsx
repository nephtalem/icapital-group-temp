  ...
  return (
    <section className="relative grid h-screen w-screen">
      ...
      <div className="absolute grid justify-items-center self-center justify-self-center px-5 md:px-48">
        ...
        <p className="mt-[1rem] hyphens-auto text-justify text-2xl text-white md:mt-[2rem] md:text-center md:text-[1.2rem] md:leading-[1.6rem]">
          {description}
        </p>
        <Link
          className="mt-[2rem] flex h-[3.6rem] cursor-pointer items-center border-2 border-white  px-8 text-[1rem] font-medium leading-[1.5rem] text-white md:mt-[5rem]"
          href={link.to}
        >
          {link.label}
        </Link>
