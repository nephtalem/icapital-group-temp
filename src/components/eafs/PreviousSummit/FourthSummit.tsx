...
const FourthSummit = () => {
  return (
    <section className="font-urbanist bg-gray-50 py-20">
      <div className="container mx-auto px-6">
        <motion.div
          className="flex flex-col items-start gap-16 md:flex-row-reverse"
        ...
        >
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-4xl font-bold tracking-wide text-[#1A365D]">
              4<sup className="text-lg">th</sup> Summit
            </h2>
            ...
            <Link href="/eafs/previous-summit/4">
          ...
          <div className="w-full md:w-1/2">
            <div className="overflow-hidden rounded-lg shadow-lg">
              <Image
                src={summitBanner}
                alt="4th East Africa Finance Summit"
