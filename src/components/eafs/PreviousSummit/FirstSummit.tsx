...
const FirstSummit = () => {
  return (
    <section className="font-urbanist border-b border-gray-100 bg-white py-20">
        ...
        >
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-4xl font-bold tracking-wide text-[#1A365D]">
              1<sup className="text-lg">st</sup> Summit
            </h2>
            ...
            <Link href="/eafs/previous-summit/1">
          ...
          <div className="w-full md:w-1/2">
            <div className="overflow-hidden rounded-lg shadow-lg">
              <Image
                src={summitBanner}
                alt="1st East Africa Finance Summit"
